...
public class ReportController extends BaseController {
    ...
    @Operation(summary = "Get report categories and types")
    ...
    public ResponseEntity<ApiResponse<ReportManagementResponse.GenerateReportResponse>> generateReport(@Valid @RequestBody GenerateReportRequest request) {
    ...
    public ResponseEntity<ByteArrayResource> downloadReport(@PathVariable UUID reportId) {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, ContentDisposition.attachment().filename(reportFile.getFilename()).build().toString())
                .body(resource);
    }
