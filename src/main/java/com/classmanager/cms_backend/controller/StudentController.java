...
public class StudentController extends BaseController {
    ...
    @Operation(summary = "Generate or reset a student's login password")
    public ResponseEntity<ApiResponse<StudentResponse>> generateStudentPassword(@PathVariable UUID studentId,
                                                                                @Valid @RequestBody GenerateStudentPasswordRequest request) {
        return ResponseEntity.ok(ApiResponse.success(studentService.generateStudentPassword(studentId, request, currentUserId()),
                "Student login credentials generated successfully"));
    }
